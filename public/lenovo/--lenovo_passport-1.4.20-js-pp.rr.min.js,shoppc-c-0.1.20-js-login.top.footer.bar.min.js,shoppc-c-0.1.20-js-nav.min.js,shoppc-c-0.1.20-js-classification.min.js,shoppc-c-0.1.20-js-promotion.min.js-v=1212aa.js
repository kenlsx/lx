...
function toSchool(a){var b=null;b=setTimeout(function(){$("#hot_school .hot_sch_big").animate({height:"100px"},300,function(){$("#hot_school .hot_sch_big").hide(0),$("#hot_school .hot_sch_small").css("display","block").show(0),$(".sch_tomin").hide(0),$(".sch_close").show(0)})},a),$("#hot_school .sch_tomin").click(function(){clearTimeout(b),$("#hot_school .hot_sch_big").animate({height:"100px"},300,function(){$("#hot_school .hot_sch_big").hide(0),$("#hot_school .hot_sch_small").css("display","block").show(0),$(".sch_tomin").hide(0),$(".sch_close").show(0)})}),$("#hot_school .sch_close").click(function(){$("#hot_school .hot_sch_small").animate({height:"0px"},300,function(){$("#hot_school .hot_sch_small").hide(0)})})}$(function(){toSchool($("#_le_ad_autotime").val())});
