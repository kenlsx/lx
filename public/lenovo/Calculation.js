...
countdown.prototype.getcachetime = function(){
    ...
    if(location.href.indexOf('lenovouat')!=-1){
        var cachetimeurl = "https://papi.lenovouat.com/" 
    }else{
...
function setFlash(){
    ...
    function flash(){
        $.ajax({
            type: "get",
            async: false,
            url:  "https://"+(isProduction ? "https://m1.lefile.cn/lenovo_components/plugin/promotion.lenovouat.com":"https://m1.lefile.cn/lenovo_components/plugin/promotion.lenovo.com.cn")+"/api/activity/getActivityBatch.jhtm",
   ...
   //库存查询
    function sellout (json){
        var url =(isProduction ? "https://m1.lefile.cn/lenovo_components/plugin/papi.lenovouat.com":"https://m1.lefile.cn/lenovo_components/plugin/papi.lenovo.com.cn");
        if(isLecoo){
            url= ($(".Calculation_20180704").find(".lis>a").eq(0).attr("href").indexOf("lecoo.lenovouat") > 0?"https://m1.lefile.cn/lenovo_components/plugin/papilecoo.lenovouat.com":"https://m1.lefile.cn/lenovo_components/plugin/papi.lecoo.com")
        }
        var stockCode = [];
 ...
 function makeAppointment(code){
    ...
    if(document.domain.indexOf('lenovouat') == -1){
        ...
        cartDoman = "https://promotion.lenovo.com.cn/";
        pDoman = "https://promotion.lenovo.com.cn/api/getSeckillActivityReservationUserNum.jhtm";
    }else{
        loginUrl = "//reg.lenovouat.com/auth/v1/login?ticket=b044d754-bda2-4f56-9fea-dcf3aecfe782&iswap=0&ru=";
        cartDoman = "https://promotion.lenovouat.com/";
        pDoman = "https://promotion.lenovouat.com/api/getSeckillActivityReservationUserNum.jhtm";
    }   
    if(!$pd[code]){
