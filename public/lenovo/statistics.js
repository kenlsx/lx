...
$(function () {
    ...
    try {
        if (domain.indexOf('m.lenovo') != -1) {
            ...
            if (domain.indexOf('https://m1.lefile.cn/ga_monitor/wapindex.html') != -1&&domain.indexOf('tryhtml') != -1) {//已经在页面中加上，新品试用
                return;
            }

            if (domain.indexOf('lenovo_wap_platform') != -1 && domain.indexOf('https://m1.lefile.cn/ga_monitor/category.html') != -1) {//分类页面
            ...
            if (domain.indexOf('https://m1.lefile.cn/ga_monitor/serviceindex.html') != -1) {//联想服务
            ...
            if (domain.indexOf('https://m1.lefile.cn/ga_monitor/pad.html') != -1) {//联想平板电脑
            ...
            if (domain.indexOf('https://m1.lefile.cn/ga_monitor/lenovo_channel_shuma.html') != -1) {//联想数码
            ...
            $(".sort-list ul li>a").each(function (index, ele) {
                    $(ele).on('click', function () {
                        ...
                        if (/(undefined|#)/gi.test(href)) {
                            href = "index.htm"/*tpa=https://shop.lenovo.com.cn/*/;
                        }
                        try {
            ...
            $(".new_star_pro201711161010 .star_pro_container .right_list a").each(function (index, ele) {
                var _t = $(this);
                var name = $('https://m1.lefile.cn/ga_monitor/ul.star_pro_head_hot li.cur').attr('latag');
        ...
        else if (domain.index("lenovovip") != -1) {
