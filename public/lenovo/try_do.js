// JavaScript Document
var mainUrl = "//"+window.location.host || "https://www.lenov.com.cn/";
...
var Try = (function(){
    ...
    _try.share = function(){
       /* $(".try_ban_share").hover(function(){
		...
		$("body").prepend('<script type="text/javascript" src="clipboard.min.js"/*tpa=https://shop.lenovo.com.cn/c2c/new/src/js/clipboard.min.js*/></script>');
		
		$("#modelUrl").load("https://shop.lenovo.com.cn/c2c/new/modelUrl.html");
							...
							if(passport.isLogin()==true){
								$.ajax({
									...
									success:function(data){
										if(data.rc==0){
											if(data.isapply==0){
												//window.location.href ="https://shop.lenovo.com.cn/tryout/js/try_question.html";
												window.location.href = "https://shop.lenovo.com.cn/tryout/tryhtml/try_question.html?gcode=" + myCode;
...
Mytryout.prototype.gotoSubmitReport = function(goods,title){ //
	...
	gotoReport.find("input").bind("click",function(){
		...
		window.location.href="https://shop.lenovo.com.cn/tryout/s_report/index.html?gcode=" + goods + "&title=" + title;
	})
}
